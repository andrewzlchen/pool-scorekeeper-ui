/*
 * FILE CONTENTS COPY/PASTED FROM:
 * https://github.com/mongodb-university/realm-template-apps/blob/2ffc6973b1d78ebfcfd19881091a4f80de24f7f9/other/web-js/client/src/components/RealmApp.js
 */
...
const RealmAppContext: React.Context<any> = React.createContext(null);
...
export function RealmAppProvider({ appId, children }: RealmAppProviderProps) {
  ...
  const logIn = React.useCallback(
    async (credentials: Realm.Credentials<{ [x: string]: unknown; }>) => {
